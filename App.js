...
class App extends Component {
  ...
  handleAddList(s) {
    ...
    console.log('handleAddList was activated');
    // this.setState({lists : s.lists});
    ...
    // here
    this.setState({
      lists : this.state.lists.concat(s.lists),
      // items : this.state.lists.concat(s.lists),
      items : {
        input : s.items,
      }
    },
    ...
    // () => this.props.lists()
    //  () => console.log(this.state.lists +":"+ this.state.items +": was updated"),
    )
